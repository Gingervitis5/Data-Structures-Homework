	...
	public int countSpace(String str) {	
		if (str.equals("")) {
			...
			if (str.substring(0,1).equals(" ")) {
				return 1 + countSpace(str.substring(1, str.length()));
			}
			else {
				return countSpace(str.substring(1,str.length()));
			}
		}
	...
	public boolean myContains(String s1, String s2){
		if (s1 == null || s2 == null) {
			...
			if (s2.substring(0,s1.length()).equals(s1)) {
				...
				return myContains(s1, s2.substring(1, s2.length()));
			}
		}
	}
